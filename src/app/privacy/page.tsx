export const metadata = { title: "Privacy Policy", alternates: { canonical: "https://habittrackerspot.com/privacy" } };
...
export default function PrivacyPage() {
  return (
    <div className="max-w-3xl mx-auto px-4 sm:px-6 py-10 space-y-4">
      ...
      <p>Habit Tracker Spot (&quot;we,&quot; &quot;us,&quot; or &quot;our&quot;) operates this website. This policy explains how we collect, use, and protect your information.</p>
      ...
      <p>Email: <a className="text-cyan-700 underline" href="mailto:privacy@Habit Tracker Spot">privacy@Habit Tracker Spot</a></p>
    </div>
  );
}
